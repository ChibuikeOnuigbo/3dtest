...
**Status:** RESEARCH ONLY / NOT EXECUTED. Detailed source report: `../repo_fps-asset-kit.md`.

## Architecture
No runtime. Asset aggregate informs intake process; explicitly Flat Guns are rejected for visual mismatch.
...
## Assets / licence
No root licence/individual credit files; README provenance claims require original-source evidence.
