...
**Status:** RESEARCH ONLY / NOT EXECUTED. Detailed source report: `../repo_enari-engine.md`.

## Architecture
TypeScript/Vite/Three with Ammo; useful central loader, pointer lock, world/viewmodel pass and capsule concepts. Avoid hard-coded map/mesh-name state.
...
## Assets / licence
MIT code at root; third-party map, weapon, character and media attribution means assets are not cleared.
