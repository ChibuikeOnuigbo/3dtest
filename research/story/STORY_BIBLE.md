...
During a rain-swept evening, an emergency maintenance operator reaches an unmanned coastal
...
- **Stakes:** the beacon's lane signal is the ferry crew’s safe visual fallback. A status
  ...
  fail state.
- **Tone:** wet, quiet competence under pressure. The station is practical and cared for,
...
| R3 | Relay Gallery | Vertical/technical transition; first sentry and route choice. | R2 → R4 stairs or R5 maintenance door | Disable/bypass one sentry; unlock service path | Amber cable trunk points to generator. |
