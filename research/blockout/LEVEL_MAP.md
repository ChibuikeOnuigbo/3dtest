...
| R3 Signal Court | 10 × 8 m, open glazed roof | Hall threshold → side doors | One required sentry creates `equipped → relay-cleared`; then generator door can open. | Central signal spindle, bridge rails, windows and cable trunk orient the two wings. Capture sentry/prompt/door state. |
