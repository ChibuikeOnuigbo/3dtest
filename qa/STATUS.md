...
| Direct `chromium-browser` package | BLOCKED | Requested direct package check reports `Unable to locate package chromium-browser`; see `playwright-system-chromium-browser-apt-2026-09-04.log`. |
